...
import { LayoutDashboard, MessageSquare, Inbox, Users, Lock, ShieldCheck, UserCog, ScrollText } from "lucide-react";
...
const NAV_ITEMS: NavItem[] = [
  ...
  { view: "audit",    label: "Audit",    icon: ScrollText, requireFlag: "Administrator" },
